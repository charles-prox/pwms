                ...
                <CardBody className="p-0">
                    <div className="flex flex-col gap-5 p-8">
                        ...
                        <p className="text-sm max-w-xl">
                            ...
                            be prompted to enter a secure, random token during
                            authentication. You can retrieve this token from
                            your phone's authenticator application (e.g., Google
                            ...
                            <div>
                                <div className="flex flex-col gap-2 mt-2 max-w-xl text-sm">
                                    <p className="font-semibold">
                                        ...
                                        two factor authentication device is
                                        lost.
                                    </p>
                                    <p className="font-semibold">
                                        These codes will not be shown again, and
                                        they will not be available if you
                                        refresh the page or leave this page.
                                    </p>
                                </div>
